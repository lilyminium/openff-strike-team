...
CHECKMOL_GROUPS: dict[str, str] = {
    ...
    "Carboxylic Acid Amide Acetal": "[#6,#1]-[#6X4:1](-[#8X2:2]-[#6,#1])(-[#8X2:3]-[#6,#1])-[#7X3:4](-[#6,#1])-[#6,#1]",
    "Ketene": "[#8:1]=[#6X2:2]=[#6X3:3](-[#6,#1])-[#6,#1]",
    "Organometallic": "[#6:1]-[#3,#12:2]", # organolithium, organomagnesium
    "Phosphoric Acid": "[#15:1](=[#8X1:2])(-[#8X2]-[!#6])(-[#8X2]-[!#6])-[#8X2]-[!#6]",
    "Sulfenic Acid Halide": "[#6:1]-[#16X2:2]-[#9,#17,#35,#53:3]",
    "Sulfuryl Halide": "[#8X1:1]=[#16X4:2](=[#8X1:3])(-[!#6&!#1:4])-[#9,#17,#35,#53]",
    "Thiocarbamic Acid Halide": "[#6X3:1](=[#16X1:2])(-[#9,#17,#35,#53:3])-[#7X3:4](-[#1,#6])-[#1,#6]",
    "Thiocarbonic Acid Ester Halide": "[#6X3:1](=[#16X1:2])(-[#8X2:3]-[#6])-[#9,#17,#35,#53:4]",
    "Thiophosphoric Acid": "[#15:1](=[#16X1:2])(-[#8X2]-[!#6])(-[#8X2]-[!#6])-[#8X2]-[!#6]",
    "Thiophosphoric Acid Halide": "[#15:1](=[#16X1:2])(-[#9,#17,#35,#53:3])(-[#8,#7,#9,#17,#35,#53])-[#8,#7,#9,#17,#35,#53]",

    # 1-4 coverage
    "Carbamic Acid Halide": "[#6X3:1](=[#8X1:2])(-[#9,#17,#35,#53:3])-[#7X3:4](-[#1,#6])-[#1,#6]",
    "Carbodiimide": "[#1,#6]-[#7X2:1]=[#6X2:2]=[#7X2:3]-[#1,#6]",
    "Carbonic Acid Ester Halide": "[#6X3:1](=[#8X1:2])(-[#8X2:3]-[#6])-[#9,#17,#35,#53:4]",
    "Carboxylic Acid Azide": "[#6]-[#6X3:1](=[#8X1:2])-[#7X2:3]=[#7X2+1:4]=[#7X1-1:5]",
    "Cyanate": "[#6]-[#8X2:1]-[#6X2:2]#[#7X1:3]",
    "Enediol": "[#1,#6]-[#6X3:1](-[#8X2]-[#1,#6])=[#6X3:2](-[#8X2]-[#1,#6])-[#1,#6]",
    "Nitrite": "[#1,#6]-[#8X2:1]-[#7X2:2]=[#8X1:3]",
    "Sulfenic Acid Ester": "[#6:1]-[#16X2:2]-[#8X2:3]-[#6:4]",
    "Acyl Cyanide": "[#1,#6]-[#6X3:1](=[#8X1:2])-[#6X2:3]#[#7X1:4]",
    "Phosphoric Acid Halide": "[#15:1](=[#8X1:2])(-[#9,#17,#35,#53:3])(-[#8X2]-[#1,#6])-[#8X2]-[#1,#6]",
    "Sulfenic Acid": "[#6:1]-[#16X2:2]-[#8X2:3]-[#1:4]",
    "Sulfinic Acid Halide": "[#1,#6]-[#16X3:1](=[#8X1:2])-[#9,#17,#35,#53:3]",
    "Carbonic Acid Monoester": "[#6X3:1](=[#8X1:2])(-[#8X2:3]-[#1])-[#8X2:4]-[#6]",
    "Carboxylic Acid Orthoester": "[#1,#6]-[#6X4:1](-[#8X2]-[#6])(-[#8X2]-[#6])-[#8X2]-[#6]",
    "Sulfinic Acid Ester": "[#1,#6]-[#16X3:1](=[#8X1:2])-[#8X2:3]-[#6]",
    "Sulfuric Acid Diester": "[#8X1:1]=[#16X4:2](=[#8X1:3])(-[#8X2:4]-[#6])-[#8X2:5]-[#6]",

    # 5-9 coverage
    "CO2 Derivative": "[#6&!$([*]~[#6,#1])]",
    "Sulfuric Acid": "[#8X1:1]=[#16X4:2](=[#8X1:3])(-[#8X2:4]-[!#6])-[#8X2:4]-[!#6]",
    "Tertiary Aromatic Amine": "[a:2]-[#7X3:1](-[a:3])-[a:4]",
    "Thioketone": "[#6X3:1](=[#16X1:2])(-[#6])-[#6]",
    "Thiocyanate": "[#6]-[#16X2:1]-[#6X2:2]#[#7X1:3]",
    "Thiosemicarbazide": "[#1,#6]-[#7X3:1](-[#1,#6])-[#6X3:2](=[#16X1:3])-[#7X3:4](-[#1,#6])-[#7X3:5](-[#1,#6])-[#1,#6]",
    "Imidoyl Halide": "[#1,#6]-[#6X3:1](=[#7X2:2]-[#1,#6])-[#9,#17,#35,#53:3]",
    "Sulfenic Acid Amide": "[#6:1]-[#16X2:2]-[#7X3:3](-[#6,#1])-[#6,#1]",
    "Alkyl Iodide": "[#6:1]-[#53:2]",
    "Diazonium Salt": "[#6]-[#7X2:1]=[#7X1+1:2]",
    "Nitrate": "[#6]-[#8X2:1]-[#7X3:2](~[#8X1:3])~[#8X1:4]",
    "Thiosemicarbazone": "[#1,#6]-[#6X3:1](-[#1,#6])=[#7X2:2]~[#7:3](-[#1,#6])-[#6X3](=[#16X1])-[#7X3](-[#1,#6])-[#1,#6]",
}
